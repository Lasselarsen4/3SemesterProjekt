...
namespace WebshopAPI.Database
{
    ...
    public void Add(Product product)
    {
        ...
        {
            string query =
                "INSERT INTO Product (ProductName, ProductPrice, ProductDescription) VALUES (@Name, @Price, @Description)";
    ...
    public void Update(Product product)
    {
        ...
        {
            string query =
                "UPDATE Product SET ProductName = @Name, ProductPrice = @Price, ProductDescription = @Description WHERE ProductId = @Id";
